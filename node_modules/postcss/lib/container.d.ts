...
declare namespace Container {
  ...
  export interface ValueOptions {
    /**
     * String that‚Äôs used to narrow down values and speed up the regexp search.
     */
    fast?: string
...
declare abstract class Container_<Child extends Node = ChildNode> extends Node {
  /**
   * An array containing the container‚Äôs children.
   *
   * ```js
  ...
  /**
   * Returns a `child`‚Äôs index within the `Container#nodes` array.
   *
   * ```js
   ...
   *
   * @param oldNode Child or child‚Äôs index.
   ...
   * ```
   *
   * @param child Child or child‚Äôs index.
   * @return This node for methods chain.
   */
  ...
  /**
   * Traverses the container‚Äôs descendant nodes, calling callback
   * for each r – Ü ‘ â ÿ å ‹ è ‰ Ü Ë â Ï å  è Ù í ¯ ï ¸ ò  õ Ü å Œ — ‘ ◊  ⁄ $› (‡ ,„ <è @Œ `Ü då hò lŒ p— t‘ x◊ |⁄ Ä› àÜ åå êè îŒ ò— ú‘ †◊ §⁄ ¨Ü ∞â ¥å ∏∞ ºø ¿¬ ƒÊ »È –Ü ‘â ÿå) É ~) É °.  }.  Ü.  •. # Æ. + Æ. 3  . ;  . C –. K  . S ?. [ Z. c p. k øI É æc s ≈i É ¸i É &	É { ˆÉ s ≈â É °â É ~£ s ≈© É V	© É è	√ s ≈… É ~… É °… ã Œ	„ s ≈È É ~È É °s ≈	É °	É ~#{ œ#s ≈)É ‹	C{ ˜Cs ≈IÉ 
IÉ N
cs ≈iÉ ã
iÉ À
iÉ iÉ BÉs ≈âÉ ÇâÉ ø£s ≈©É ˇ©ã 7√s ≈√ì  …É D…É h„{ %ÈÉ °ÈÉ ~	É °	É ~)É ~)É °IÉ ~IÉ °cs =c£  c´  iÉ °iÉ ~És =É£  É´  âÉ ââÉ ∆âÉ ˇ©É ~©É °…É  ÈÉ  	É  )É  IÉ  iÉ  âÉ  ©É  …É  ÈÉ <	É P)É d)õ  IÉ ÖiÉ ôiõ  âÉ ∫©É €…≥ •È≥ •i≥ •â≥ •- M r † ∫ Œ Í.H\ù  	  
     &  +  4   t8  	8  ö=  oA  [8  pF  A8  O8  ÷8  ]8  t8  @8  #=  ﬂ=  Ä8  @K  ™=  ºP  =  †8  S8  ëU  ΩZ  ®_  ëU  g_  ~_  ˆd  ÷d  Ïh  ØF  ∞F  È=  ¿=  ¢=  =  ¨F  m  %s  Îy  üy  ‚y  m  %s  7y  