...
* `options` **{Object}**: See available [options](#options) for chan                                                                                      ë ¿                   8± ¿   @± ¿     ¿           ≈             q ¿                                                          H   
                                                   (∞  0∞  FDO_REQUEST_CONTEXT     FDO_CONTEXT     FDO_FILEOBJECT_CONTEXT  PDO_CONTEXT     PDO_REQUEST_CONTEXT     P s G e t V e r s i o n         W m i T r a c e M e s s a g e   W m i Q u e r y T r a c e I n f o r m a t i o n         E t w R e g i s t e r C l a s s i c P r o v i d e r     E t w U n r e g i s t e r       À{pmy”7mÿ)ft±©Ç/≤Q] ¡@ö0Ì	˜.lF u n c t i o n D r i v e r O p t I n   V h f M o d e   _†ç4nR<î)6£dÒ|N U L L         V H F \ H I D _ D E V I C E _ S Y S T E M _ V H F       H I D _ D E V I C E _ S Y S T E M _ V H F       V H F \ V I D _ % 0 4 X & P I D _ % 0 4 X       M i c r o s o f t       H I D   V H F   D r i v e r     1 . 0   á'ñ%CgCÑøúÉÚH                [Ø“9ô1uµ]Hı»x_ÄÒzæC>ªSY^—Hó«§àõßD0ã>o‡ìVWKK m d f L i b r a r y   DriverEntry failed 0x%x for driver %wZ
...
  ( n u l l )     FxStubBindClasses: WDF_CLASS_BIND_INFO 0x%p, class %S, size 0x%x incorrect, expected 0x%Ix, status 0x%x
        FxStubBindClasses: invalid driver image.
...
                            ´AL£           Ñx  Ñh      ´AL£       0  §x  §h      ´AL£       $   ‘z  ‘j  RSDSrImsf‡AjæwŒÁoU   vhf.pdb GCTL   `W  .text$mn    `g      .text$mn$00 Äg  ©  .text$mn$21  p    .rdata$brc  q     .giats   q  d  .rdata  Ñx  t  .rdata$zzzdbg   ¯z  (  .xdata   ê    .data$brc   ë     .data    ë     .kmdfclassbind$a    0ë     .kmdfclassbind$c    8ë     .kmdfclassbind$d    @ë     .kmdftypeinit$a Pë     .kmdftypeinit$c `ë  8  .bss     †  t  .pdata   ∞  8  .idata$5    8±     .00cfg  H±  P   .idata$2    ò±     .idata$3    ∞±  8  .idata$4    Ë≤  @  .idata$6     ¿  |&  PAGE       Ú  INIT       \   .gfids    `   .rsrc$01    ` ®  .rsrc$02        rImsf‡AjæwŒÁoUYwÈg∂ÄÀΩﬂEã´AL£ d 4
 rp d 4 íp	 	rP 
d T 4 r‡–¿p B  
 d
 T	 4 Rp )d 4 2p
 	4 ≤
‡p`P R0 d	 4 Rp 4 íP T 4 ≤p
 d T 4 “p T 4 ≤` d 4 ≤p ‰ t d 4  P   d 4 “p ‰ t d 4  P   d 4 ≤p t d T 4 ≤‡! !46 !. ‡–¿p`P   b   	
d 4 í‡–¿pP
 	4 í‡
p	`P!
 T 4 ≤p`Hf  P   "
